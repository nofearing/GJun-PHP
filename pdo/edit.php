                ...
                <form action="update.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="skills[]" id="design" value="平面設計" class="form-check-input" <?php echo in_array("平面設計", $skills) ? "checked" : ""; ?>>
                            <label for="design" class="form-check-label">平面設計</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" name="skills[]" id="web" value="網頁設計" class="form-check-input" <?php echo in_array("網頁設計", $skills) ? "checked" : ""; ?>>
